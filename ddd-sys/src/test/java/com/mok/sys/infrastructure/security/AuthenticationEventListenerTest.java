...
class AuthenticationEventListenerTest {
    ...
    void onApplicationEvent_LoginSuccessfulEvent_HandlesSuccess() {
        ...
        LoginSuccessfulEvent event = new LoginSuccessfulEvent(authentication, null, java.util.Locale.getDefault());
    ...
    void onApplicationEvent_LoginFailedEvent_HandlesFailure() {
        ...
        LoginFailedEvent event = new LoginFailedEvent(response, null, null, java.util.Locale.getDefault());
    ...
    void handleLoginSuccess_CreatesLoginLog() {
        ...
        try {
            ...
            method.invoke(listener, new LoginSuccessfulEvent(authentication, null, java.util.Locale.getDefault()));
        } catch (Exception e) {
    ...
    void handleLoginFailure_SourceNotAuthenticationResponse() {
        ...
        LoginFailedEvent event = new LoginFailedEvent(otherSource, null, null, java.util.Locale.getDefault());
